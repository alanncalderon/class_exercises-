...
#1st we need to open the file and start reading line by line
with open (filename) as fp:
    #read line by line
    for line in fp:
        #save the oiginal line
        ...
        for p in punctuation:
            line = line.replace(p,"")
        line = line.rstrip() #this removed enter at the end
        #Check if palindrome
        if line == line[::-1]:
            ...
            print(f"{orig_line} is no palindrome")
